        ...
        <div class="card-body">
            <table id="example1" class="table table-striped table-bordered">
                ...
                <?php while($row=mysqli_fetch_array($select)){
					...
					if($row['FLD_QAFDT']!=''){
                    $timestamp1_1 = strtotime($row['FLD_ERDAT']);
					$timestamp2_2 = strtotime($row['FLD_QAFDT']);			
						
						
					$diff_2 = abs($timestamp1_1 - $timestamp2_2);
                ...
                echo date("d-M-y", strtotime($row['FLD_TDATE']));    
                }
                ...
                echo date("d-M-y", strtotime($row['FLD_QAFDT']));    
                }

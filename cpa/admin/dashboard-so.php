...
$select_all = mysqli_query($db,"select * from complain where Serno > '0' and email='".$_SESSION['user_name']."' and c_year='".date('Y')."'");
$count_all  = mysqli_num_rows($select_all);

$select_qc = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and email='".$_SESSION['user_name']."' and (cstatus='Pending' or cstatus='Objected' )
                               and c_year='".date('Y')."'");
$count_qc  = mysqli_num_rows($select_qc);

$select_gm = mysqli_query($db,"SELECT * FROM complain  where Serno > '0' and email='".$_SESSION['user_name']."' and cstatus='Approved' and c_year='".date('Y')."'");
$count_gm  = mysqli_num_rows($select_gm);

$select_so = mysqli_query($db,"SELECT * FROM complain  where Serno > '0' and email='".$_SESSION['user_name']."' and cstatus='Completed' and c_year='".date('Y')."' and sRemarks is null");
$count_so  = mysqli_num_rows($select_so);

$select_cp = mysqli_query($db,"SELECT * FROM complain  where Serno > '0' and email='".$_SESSION['user_name']."' and c_year='".date('Y')."' and sRemarks!=''");
...
$complaints= mysqli_query($db,"SELECT * FROM complain where Serno > '0' and email='".$_SESSION['user_name']."' and c_month='".$month."' and c_year='".date('Y')."'");
...
while($row_qc     = mysqli_fetch_array($select_qcw)){
	...
	$select_qcw_2 = mysqli_query($db,"SELECT * FROM complain WHERE Serno > '0' and comp_for='".$row_qc['di']."' and email='".$_SESSION['user_name']."'
	                                  and c_year='".date('Y')."'");
...
$select_cs   = mysqli_query($db,"SELECT comp_stage,count(*) as cs_total FROM complain where Serno > 0 and email='".$_SESSION['user_name']."'
...
$select_c_all = mysqli_query($db,"SELECT DISTINCT(cust_name) FROM complain where Serno > '0' and email='".$_SESSION['user_name']."' and c_year='".date('Y')."' GROUP by cust_name");
$count_c_all  = mysqli_num_rows($select_c_all);

$select_n_c = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and email='".$_SESSION['user_name']."' and comp_sample='No' and c_year='".date('Y')."'");
...
<head>
    ...
    <title><?php echo $title;?>Sale Officer Dashboard</title>
...
<div class="navigation">
    ...
    <div class="navigation-menu-body">
        <ul id="navigationDashboards" class="navigation-active">
            ...
            <li>
                <a class="active" href="dashboard-so.php?email=<?php echo $_SESSION['user_name'];?>">Overview</a>
            </li>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard-so.php?email=<?php echo $_SESSION['user_name'];?>">Dashboard</a></li>
                    ...
                    <div class="card border mb-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center mb-3">
                               ...
                               <a href="lab-pending.php?email=<?php echo $_SESSION['user_name'];?>" target="_blank"> <span class="text-uppercase font-size-11">Lab - Pending Approvals</span></a>
                    ...
                    <div class="card border mb-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="gm-pending.php?email=<?php echo $_SESSION['user_name'];?>" target="_blank"><span class="text-uppercase font-size-11">GM - Pending Approvals</span></a>
                    ...
                    <div class="card border mb-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="so-pending.php?email=<?php echo $_SESSION['user_name'];?>" target="_blank"><span class="text-uppercase font-size-11">Sale Officer - Pending Approvals</span></a>
                    ...
                    <div class="card border mb-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="completed.php?email=<?php echo $_SESSION['user_name'];?>" target="_blank"><span class="text-uppercase font-size-11">Completed</span></a>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table m-b-0">
							...
							$select_recents = mysqli_query($db,"select * from complain where Serno > 0 and email='".$_SESSION['user_name']."'

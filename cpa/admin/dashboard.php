...
$select_all = mysqli_query($db,"select * from tbl_cpa where FLD_ID > '0' and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and FLD_YEAR='".date('Y')."' and FLD_CFLAG!='Deleted'");
$count_all  = mysqli_num_rows($select_all);

$select_qc = mysqli_query($db,"SELECT * FROM tbl_cpa where FLD_ID > '0' and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and (FLD_CFLAG='Pending' or FLD_CFLAG='Objected' )
                               and FLD_YEAR='".date('Y')."'");
$count_qc  = mysqli_num_rows($select_qc);

$select_qa= mysqli_query($db,"SELECT * FROM tbl_cpa  where FLD_ID > '0' and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and (FLD_CFLAG='QA Pending' or FLD_CFLAG='QA Followup' ) and FLD_YEAR='".date('Y')."'");
$count_qa  = mysqli_num_rows($select_qa);

$select_co = mysqli_query($db,"SELECT * FROM tbl_cpa  where FLD_ID > '0' and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and FLD_CFLAG='Completed' and FLD_YEAR='".date('Y')."'");
...
$complaints= mysqli_query($db,"SELECT * FROM tbl_cpa where FLD_ID > '0' and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and FLD_MONTH='".$month."' and FLD_YEAR='".date('Y')."' and FLD_CFLAG!='Deleted'");
...
while($row_qc     = mysqli_fetch_array($select_qcw)){
	...
	$select_qcw_2 = mysqli_query($db,"SELECT * FROM tbl_cpa WHERE FLD_ID > '0' 
							    and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and FLD_FISU='".$row_qc['FLD_ID']."' and FLD_YEAR='".date('Y')."' and FLD_CFLAG!='Deleted'");
...
$select_ft   = mysqli_query($db,"SELECT FLD_FTYPE,count(*) as FT_TOTAL FROM tbl_cpa where FLD_ID > 0 and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and  FLD_YEAR ='".date('Y')."' and FLD_CFLAG!='Deleted' group by FLD_FTYPE");
...
$select_ct   = mysqli_query($db,"SELECT FLD_CTYPE,count(*) as CT_TOTAL FROM tbl_cpa where FLD_ID > 0 and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and  FLD_YEAR ='".date('Y')."' and FLD_CFLAG!='Deleted' group by FLD_CTYPE");
...
$select_dp   = mysqli_query($db,"SELECT FLD_DNAME,count(*) as DP_TOTAL FROM tbl_cpa where FLD_ID > 0 and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and  FLD_YEAR ='".date('Y')."' and FLD_CFLAG!='Deleted' group by FLD_DNAME");
...
$select_cp   = mysqli_query($db,"SELECT FLD_CFLAG,count(*) as CP_TOTAL FROM tbl_cpa where FLD_ID > 0 and FLD_DNAME='".$_SESSION['FLD_DNAME']."' and  FLD_YEAR ='".date('Y')."' and FLD_CFLAG!='Deleted' group by FLD_CFLAG");

...
<head>
    ...
    <title><?php echo $title;?>QA Pending</title>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:">QA Pending</a></li>
    ...
    <div class="card">
        <div class="card-body">
            <table id="example1" class="table table-striped table-bordered">
				...
				<?php 
				  ...
				  if($_SESSION['FLD_BTYPE']=='Admin'){
					$select_recents = mysqli_query($db,"select * from tbl_cpa where FLD_ID > 0 and FLD_CRTBY='".$_SESSION['FLD_ID']."'
														and FLD_YEAR='".date('Y')."' and FLD_CFLAG='QA Pending'
		       ...
		       ?>
                <tr>
                <td><a href="qa-pending-detail.php?id=<?php echo base64_encode($row_recent['FLD_ID']);?>" ><?php echo $row_recent['FLD_ID'];?></a></td>
				...
				<?php 
                                ...
                                <a href="qa-pending-detail.php?id=<?php echo base64_encode($row_recent['FLD_ID']);?>" style="color:green;">Detail</a></a>

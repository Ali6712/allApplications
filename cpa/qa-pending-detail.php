...
<div class="card">
        <div class="card-body">
            <?php 
                   ...
                   $users= mysqli_query($db,"SELECT * FROM tbl_usr02 where FLD_ID='".$cpa['FLD_CRTBY']."'");
				   $user = mysqli_fetch_array($users); 				

	 
		       ?>
            <form class="needs-validation" novalidate="" action="controllers/cpa.php?edit=qa-pending&id=<?php echo $_GET['id'];?>" method="POST"  enctype="multipart/form-data">
                <div class="form-row">
					...
					<div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                             <input type="text" class="form-control" id="FLD_CRDT2" name="FLD_CRDT2"  value="<?php echo $cpa['FLD_CRDT'];?>"  disabled>
					...
					<div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="FLD_CRTBY"  name="FLD_CRTBY" aria-describedby="validationTooltipUsernamePrepend" value="<?php echo $user['FLD_BNAME'];?>"  disabled>
				    ...
				    while($uc = mysqli_fetch_array($ucs)){
						...
						if($uc['FLD_CORAC']!=''){
						$count = $count + 1;	
						$FLD_CORAC = $count.'-'.$uc['FLD_CORAC'].'  <br><span style="font-size:9px !important;font-style: italic;">Date: '.$uc
...
['FLD_DDATE'].'<span>';
					...
					<div class="col-md-12 mb-3">
                        <label for="validationTooltipUsername">Is  system reviewed to resolve similir issue elswhere  and corrective action planned?   </label>
                        <div class="input-group">
                           <textarea rows="6" style="width:100%;" class="form-control"  id="FLD_COMT2" name="FLD_COMT2" aria-describedby="validationTooltipUsernamePrepend" disabled><?php echo $cpa['FLD_COMT2'];?></textarea>
                        </div>
                    </div>		
					<div class="col-md-6 mb-3">
					...
					<div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                           <?php if($cpa['FLD_CFLAG']=='QA Pending'){
									$FLD_CFLAG= 'Compliance Pending';
									
								}elseif($cpa['FLD_CFLAG']=='Awareness Required'){
									$FLD_CFLAG= 'Documents Update / Awareness Required';

									}else{
									$FLD_CFLAG= $cpa['FLD_CFLAG'];
									
								};?>
                            <input type="text" class="form-control" id="FLD_CFLAG1" name="FLD_CFLAG1" aria-describedby="validationTooltipUsernamePrepend" disabled value="<?php echo $FLD_CFLAG;?>" >
							<input type="hidden" class="form-control" id="FLD_CFLAG"  name="FLD_CFLAG"   value="<?php echo $cpa['FLD_CFLAG'];?>" >
			...
			<div class="col-md-12 mb-3">
					...
					if($uc['FLD_FILE']!=''){
						$FLD_FILE .='<div class="col-md-12 mb-3">
						<div class="alert alert-primary" role="alert"><a href="Upload/'.$uc['FLD_FILE'].'" target="_blank" style="color:green;">View Attachment</a></div>		
					 </div>';
...
<?php 
					...
					<div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            <select id="FLD_QAFRT" name="FLD_QAFRT" class="form-control" required onchange="set_comment(this.value);">
                                   <option value="">Select</option>
					...
					<div class="col-md-12 mb-3" style="display:none;" id="feedback">
                        <label for="validationTooltipUsername">Comments (If No)  </label>
                        <div class="input-group">
                           <textarea rows="6" style="width:100%;" class="form-control"  id="FLD_COMT" name="FLD_COMT" aria-describedby="validationTooltipUsernamePrepend"></textarea>
                            <div class="invalid-tooltip">
                                Please enter finding description.
                            </div>
					...
					?>	
				<div class="col-md-12 mb-3">
                        <label for="validationTooltipUsername">Is Corrective Action Implemented and Effective ?		
</label>
                        <div class="input-group">
			    ...
			    <div class="col-md-12 mb-3">
                        <label for="validationTooltipUsername">Status
</label>
                        <div class="input-group">
                            <select id="FLD_CFLAG2" name="FLD_CFLAG2" class="form-control" 

required>
                                   <option value="">Select</option>
								   <option value="QA Followup">Compliance Followup</option>
								   <option value="Objected">Objected</option>
								   <option value="Task Delayed">Task Delayed</option>
								   <option value="Awareness Required">Documents Update / Awareness Required</option>

<div class="navigation">
    <div class="navigation-icon-menu">
        <ul>
			...
			<li data-toggle="tooltip" title="Dashboard & Reports">
                <a href="#navigationDREP" title="Dashboard & Reports">
                    <i class="icon ti-pie-chart"></i>
                </a>
            </li>
    ...
    <div class="navigation-menu-body">
        ...
        <li>
           ...
           <li>
                ...
                <ul>
                    ...
                    <li><a href="admin/pending-list.php" target="_blank">Department Pending List </a></li>
		...
		<ul id="navigationDREP">
            <li class="navigation-divider">Overview</li>
            <li><a href="admin/dashboard.php">Dashboard </a></li>
            <li><a href="admin/datewise.php">Datewise</a>
            </li>
        </ul>

...
$select_all = mysqli_query($db,"select * from tbl_usr02");
...
<main class="main-content">
    ...
    <div class="card">
        ...
        <div class="card-body">
		<div style="float:right;margin-right: 10px;"><a class="btn btn-primary" href="new-user.php">New User</a></div>
		<br>
		<br>
            <table id="example1" class="table table-striped table-bordered">
                ...
                ?>    
                 <tr>
                    <td><?php echo $row['FLD_BTYPE'];?></td>
                    <td><?php echo $dept['FLD_DNAME'];?></td>
                    <td><?php echo $row['FLD_BNAME'];?></td>
                    <td><?php echo $row['FLD_EMAIL'];?></td>
                    <td><?php echo str_repeat( "*", strlen( $row['FLD_BCODE'] ) );?></td>
                    <td><?php echo $row['FLD_UFLAG'];?></td>
					<td><a href="edit-user.php?id=<?php echo base64_encode($row['FLD_ID']);?>">Edit</a></td>

...
<div class="input-group">
<input type="text" class="form-control" id="FLD_CRDT" 

name="FLD_CRDT" aria-describedby="validationTooltipUsernamePrepend" value="<?php echo 
...
}elseif($cpa['FLD_CFLAG']=='QA Followup'){
$FLD_CFLAG= 'Compliance Followup';
...
<div class="input-group">
<textarea rows="6" style="width:100%;" class="form-control" id="FLD_COMT" name="FLD_COMT" aria-describedby="validationTooltipUsernamePrepend"><?php echo $cpa['FLD_COMT'];?></textarea>
<div class="invalid-tooltip">
Please enter finding description.
</div>
...
<option value="Awareness Required" <?php if($cpa['FLD_CFLAG']=='Awareness Required'){echo "selected='selected'";}?> >Documents Update / Awareness Required</option>

...
<head>
    ...
    <title><?php echo $title;?>New Defect</title>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:">New Defect</a></li>
...
<div class="card">
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate="" action="controllers/defect.php?insert=defect" method="POST"  enctype="multipart/form-data">

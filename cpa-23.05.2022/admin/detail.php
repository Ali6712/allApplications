...
<head>
    ...
    <title><?php echo $title;?>Completed Detail</title>
...
<textarea rows="6" style="width:100%;"  id="suggestion3" name="suggestion3" aria-describedby="validationTooltipUsernamePrepend" required readonly><?php echo $ccomplaint['suggestion3'];?></textarea>
					...
					<div class="col-md-12 mb-3">
                        <label for="validationTooltipUsername">Remarks / Objection(s) By GM</label>
                        <div class="input-group">
                            
                            <textarea rows="6" style="width:100%;"  id="objection" name="objection" aria-describedby="validationTooltipUsernamePrepend" required readonly><?php echo $ccomplaint['objection'];?></textarea>
				...
				<div class="col-md-6 mb-3">
                        <label for="validationTooltipUsername">Completed on</label>
                        <div class="input-group">
                           
                            <input type="text" class="form-control" id="sDate"  name="sDate" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $complaint['sDate'];?>" readonly>
                           
                        </div>
                    </div>
					<div class="col-md-6 mb-3">
                        <label for="validationTooltipUsername">Final Remarks</label>
                        <div class="input-group">
                           
                             <input type="text" class="form-control" id="sDate"  name="sDate" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $complaint['sRemarks'];?>" readonly>
                        </div>
                    </div>

    ...
    <div class="card">
        <div class="card-body">
            <table id="example1" class="table table-striped table-bordered">
		       ...
		       ?>
                <tr>
                <td><a href="detail.php?id=<?php echo base64_encode($row_recent['FLD_ID']);?>" ><?php echo $row_recent['FLD_ID'];?></a></td>
				...
				<td><?php //echo $row_recent['FLD_CFLAG'];?>

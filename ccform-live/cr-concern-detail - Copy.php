                ...
                <div class="form-row">
					...
					<div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
						   ...
						   <input type="text" class="form-control" id="" name="si" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $section['sname'];?>" readonly>
				    ...
				    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
							...
							<select id="mi" name="mi" class="form-control" onchange="get_op(this.value,'<?php echo $complaint['mi'] ?>');" required>
                                   <option value="">Select</option>
								<?php 
								   $machines= mysqli_query($db,"SELECT * FROM machines where si='".$complaint['si']."'and mstatus='1' order by mname asc");
								   while($machine = mysqli_fetch_array($machines)){   
								?>
								   <option value="<?php echo $machine['mi'];?>" <?php if($machine['mi']==$complaint['mi']){echo "selected='selected'";}?>><?php echo $machine['mname'];?></option>
					...
					<div class="col-md-3 mb-3">
						...
						<input type="text" class="form-control" id="oi"  name="oi" >
                           <!-- <div id="get_op">
							...
							<select id="oi" name="oi" class="form-control" required>
					...
					<div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                          <input type="text" class="form-control" id="suggestion"  name="suggestion" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $ccomplaint['suggestion'];?>">
                            <div class="invalid-tooltip">
					...
					<div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
						<input type="text" class="form-control" id="suggestion2"  name="suggestion2" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $ccomplaint['suggestion2'];?>">
						  <div class="invalid-tooltip">
					...
					<div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="suggestion3"  name="suggestion3" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $ccomplaint['suggestion3'];?>">
                            <div class="invalid-tooltip">
					...
					<?php 
					if ($ccomplaint["status_ip"] != "Objected"){
					?>
					...
					<div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="objection"  name="objection" aria-describedby="validationTooltipUsernamePrepend" readonly value="<?php echo $ccomplaint['objection'];?>">
					...
					<div class="col-md-12 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="objremarks"  name="objremarks" aria-describedby="validationTooltipUsernamePrepend"  value="<?php echo $ccomplaint['objremarks'];?>">

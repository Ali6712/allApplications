...
<head>
    ...
    <title><?php echo $title;?>Edit Product Grade</title>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:">Edit Product Grade</a></li>
...
<div class="card">
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate="" action="controllers/pgrade.php?edit=pt&id=<?php echo $row['id'];?>" method="POST"  enctype="multipart/form-data">

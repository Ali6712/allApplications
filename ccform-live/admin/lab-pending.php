...
$select = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and comp_for='".base64_decode($_GET['id'])."' and (cstatus='Pending' or cstatus='Objected' ) and c_year='".date('Y')."'");    
$url = 'dashboard-lab.php?id='.$_GET['id'];
    
}elseif(isset($_GET['email'])){
    $select = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and email='".$_SESSION['user_name']."' and (cstatus='Pending' or cstatus='Objected' ) and c_year='".date('Y')."'");   
    $url = 'dashboard-so.php?email='.$_GET['email'];
}
else{

$select = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and (cstatus='Pending' or cstatus='Objected' ) and c_year='".date('Y')."'");
$url = 'index.php';
}
...
<head>
    ...
    <title><?php echo $title;?>Lab Pendings - <?php echo date("Y");?></title>
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Lab Pending - <?php echo date("Y");?></li>
                </ol>
            </nav>
            <!-- end::breadcrumb -->

...
<div class="card">
  ...
  <div class="col-md-12">
                    ...
                    <div class="accordion accordion-success custom-accordion">
                        ...
                        <div class="accordion-row" <?php echo $background;?>>
							 ...
							 <div class="form-row">
                              <div class="col-md-6 mb-3">
								...
								<div class="input-group">
									   ...
									   <select id="dispatch_to_factory1<?php echo $pl['r1_pl_id'];?>" name="dispatch_to_factory1<?php echo $pl['r1_pl_id'];?>" class="form-control" style="margin-right:10px;">
									   ...
									   <select id="dispatch_to_factory2<?php echo $pl['r1_pl_id'];?>" name="dispatch_to_factory2<?php echo $pl['r1_pl_id'];?>" class="form-control" style="margin-right:10px;">
									   ...
									   <select id="dispatch_to_factory3<?php echo $pl['r1_pl_id'];?>" name="dispatch_to_factory3<?php echo $pl['r1_pl_id'];?>" class="form-control">
								...
								<div class="input-group">
									   ...
									   ?>
									   <select id="required_date1<?php echo $pl['r1_pl_id'];?>" name="required_date1<?php echo $pl['r1_pl_id'];?>" class="form-control" style="margin-right:10px;">
											   <option value="">Day</option>
											<?php 
									   ...
									   <select id="required_date2<?php echo $pl['r1_pl_id'];?>" name="required_date2<?php echo $pl['r1_pl_id'];?>" class="form-control" style="margin-right:10px;">
											   <option value="">Month</option>
											<?php 
									   ...
									   <select id="required_date3<?php echo $pl['r1_pl_id'];?>" name="required_date3<?php echo $pl['r1_pl_id'];?>" class="form-control">
											   <option value="">Year</option>
											<?php 
											   $year=date('Y')+10;
											   for($i=2021;$i<=$year;$i++ ){   
...
function send_to_lab(r1_pl_id){
        ...
        $.post("controllers/development.php",{r1_pl_id:r1_pl_id,marked_to_id:marked_to_id,id:id,action:'send'},function(data){   

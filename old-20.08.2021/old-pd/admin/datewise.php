...
<form class="needs-validation" novalidate="" action="datewise-result.php" method="POST" target="_blank" >
    <div class="card">
        <div class="card-body">
 ...
 <div class="col-md-6">
            <div class="form-group row">
                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">End Application</label>
                            <div class="col-sm-8">
                                <select class="js-example-basic-single" id="end_app" name="end_app">
                                    <option></option>
                                   	<?php 
								   $eas= mysqli_query($db,"SELECT DISTINCT(end_app) from complain order by end_app asc");
								   while($ea = mysqli_fetch_array($eas)){   
								?>
								   <option value="<?php echo $ea['end_app'];?>"><?php echo $ea['end_app'];?></option>
              ...
              <div class="col-md-6">
            <div class="form-group row">
                            <label for="colFormLabelSm" class="col-sm-4 col-form-label col-form-label-sm">Grade Wise</label>
                            <div class="col-sm-8">
                                <select class="js-example-basic-single" id="prod_desc" name="prod_desc">
                                    <option></option>
                                   	<?php 
								   $grades= mysqli_query($db,"SELECT DISTINCT(prod_desc) from complain order by prod_desc asc");
								   while($grade = mysqli_fetch_array($grades)){   
								?>
								   <option value="<?php echo $grade['prod_desc'];?>"><?php echo $grade['prod_desc'];?></option>

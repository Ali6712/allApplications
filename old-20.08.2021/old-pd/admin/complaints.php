            ...
            <table id="example1" class="table table-striped table-bordered">
                ...
                <?php 
								  ...
								  while($row_recent     = mysqli_fetch_array($select_recents)){	
									...
									$f_app_date_con = strtotime($app_date_con[0]);
									
									$gm_app_date   = explode(" ", $row_recent['gm_app_date']);
									$f_gm_app_date = strtotime($gm_app_date[0]);
                 ...
                 <tr>
								...
								<td><?php $duration_lab = round(abs($f_app_date_con - $timestamp1)/(60*60),2);
								...
								<td><?php $duration_gm = round(abs($f_gm_app_date - $timestamp1)/(60*60),2);

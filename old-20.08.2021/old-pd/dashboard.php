                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table m-b-0">
						  ...
						  where r2d.r1_pl_id=rpl.r1_pl_id  and marked_to_id='".$_SESSION['user_id']."' 
						  and r2_lab_received_flag='N' and rpl.r1_id=r1.r1_id ");
					...
					?>
                            ...
                            <a href="javascript:" onclick="save_lab_rec('<?php echo $row_recent['r1_pl_id'];?>');"><i class="fa fa-check"></i></a>
                        </div></td>
                            </tr>
							<?php } ?>
                            </tbody>
				   ...
				   while($row_recent     = mysqli_fetch_array($select_recents)){	
					...
					?>
                            ...
                            <tr>
								...
								<td><div class="icon-block icon-block-floating icon-block-outline-success m-r-20">
                                <a href="rank3.php?id=<?php echo base64_encode($row_recent['r1_pl_id']);?>"><i class="fa fa-check"></i></a>
                        </div></td>
                            </tr>
							<?php } 
							}
...
function save_lab_rec(r1_pl_id){
	
	    var r2_late_received_remarks  = $('#r2_late_received_remarks'+r1_pl_id).val();
        $.post("controllers/development.php",{r1_pl_id:r1_pl_id,r2_late_received_remarks:r2_late_received_remarks,action:'save_lab_rec'},function(data){   

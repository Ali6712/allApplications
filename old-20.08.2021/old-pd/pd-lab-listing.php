            ...
            <table id="example1" class="table table-striped table-bordered">
		       ...
		       ?>
                <tr>
							    ...
							    <?php if($num==0){?>
								<a href="pd-detail_2r.php?id=<?php echo base64_encode($row_recent['r1_pl_id']);?>" class="btn btn-outline-light btn-sm">PD 2 (Recommendation)</a>	
								<?php }else{?>
								
								<?php if($row_c['pd3r_flag']=='Y'){?>
								<a href="pd-detail_3r.php?id=<?php echo base64_encode($row_recent['r1_pl_id']);?>" class="btn btn-outline-light btn-sm">PD 3 (New Development)</a>	
								<?php }elseif($row_c['pd3r_flag']=='C'){?>
								<a href="pd-detail_4r.php?id=<?php echo base64_encode($row_recent['r1_pl_id']);?>" class="btn btn-outline-light btn-sm">PD 4 (Developed Sample Dispatch)</a>	
								<?php } ?>

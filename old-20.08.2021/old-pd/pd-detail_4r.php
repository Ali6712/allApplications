    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Developed Sample Dispatch</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r1_pl_id=<?php echo $pl['r1_pl_id'];?>&insert=pd_4r&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">

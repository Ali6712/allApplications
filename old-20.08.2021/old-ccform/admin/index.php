...
$select_qc = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and (cstatus='Pending' or cstatus='Objected' )
                               and c_year='".date('Y')."'");
$count_qc  = mysqli_num_rows($select_qc);

$select_gm = mysqli_query($db,"SELECT * FROM complain  where Serno > '0' and cstatus='Approved' and c_year='".date('Y')."'");
$count_gm  = mysqli_num_rows($select_gm);

$select_so = mysqli_query($db,"SELECT * FROM complain  where Serno > '0' and cstatus='Completed' and c_year='".date('Y')."' and sRemarks is null");
$count_so  = mysqli_num_rows($select_so);

$select_cp = mysqli_query($db,"SELECT * FROM complain  where Serno > '0' and c_year='".date('Y')."' and sRemarks!=''");
...
$complaints= mysqli_query($db,"SELECT * FROM complain where Serno > '0' and c_month='".$month."' and c_year='".date('Y')."'");
...
$complaints_smd_2= mysqli_query($db,"SELECT * FROM complain where Serno > '0' and comp_for='31' and c_month='".$month."' and c_year='".date('Y')."'");
...
$select_qcw = mysqli_query($db,"SELECT * FROM departments where dtype='Dept'");
...
$select_cs   = mysqli_query($db,"SELECT comp_stage,count(*) as cs_total FROM complain where Serno > 0 
...
<main class="main-content">
                    ...
                    <div class="card border mb-0">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a href="gm-pending.php" target="_blank"><span class="text-uppercase font-size-11">GM - Pending Approvals</span></a>
            ...
            <div class="card">
                ...
                <div class="card-body">
					...
					$select_recents = mysqli_query($db,"select * from complain where Serno > 0 
					                                     and c_year='".date('Y')."' order by Serno desc limit 0,6");
                    ...
                    <div class="custom-control custom-checkbox-success custom-checkbox todo-item">
                        <label class="custom-control-label d-flex justify-content-between">Compliant from "<?php echo $row_recent['cust_name'];?>" regarding "<?php echo $defect_type;?>" is received. Complaint No. is "<?php echo $row_recent['Serno'];?>". 
                            <small class="text-muted font-size-11"><?php echo date("d-M-y", strtotime($row_recent['sub_date']));?></small>
                        </label>
                    </div>
    ...
    <div class="row">
                    ...
                    <div class="table-responsive">
                        <table class="table m-b-0">
                            ...
                            <tr>
                                ...
                                <a href="delete.php?id=<?php echo base64_encode($row_recent['Serno']);?>" style="color:red;">Delete</a>
        ...
        <div class="col-xl-6 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">QC - SMD Yearly Overview - <?php echo date('Y');?></h6>
                   
                    <canvas id="chart_qc_smd"></canvas>
                </div>
            </div>
         ...
         <div class="card">
                <div class="card-body">
                    <h6 class="card-title">QC - SMD-E Yearly Overview - <?php echo date('Y');?></h6>
                   
                    <canvas id="chart_qc_smd_2"></canvas>
                </div>
            </div>
	...
	<div class="row">
        <div class="col-xl-6 col-md-12">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">QC - LMD Yearly Overview - <?php echo date('Y');?></h6>
                   
                    <canvas id="chart_qc_lmd"></canvas>
                </div>
            </div>
            </div>
         ...
         <div class="card">
                <div class="card-body">
                    <h6 class="card-title">QC - PCC Yearly Overview - <?php echo date('Y');?></h6>
                   
                    <canvas id="chart_qc_pcc"></canvas>
                </div>
            </div>

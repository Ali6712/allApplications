...
<head>
    ...
    <title><?php echo $title;?>QA Complaint Detail</title>
...
<div class="card">
        <div class="card-body">
            <?php 
		       ...
		       ?>
            <form class="needs-validation" novalidate="" action="controllers/complaints.php?edit=qa-followup-complaint&id=<?php echo base64_encode($complaint['Serno']);?>" method="POST"  enctype="multipart/form-data">
                <div class="form-row">
					...
					<div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
								...
								<?php 
								   ...
								   $sections= mysqli_query($db,"SELECT * FROM sections where si='".$complaint['si']."'");
								   $section = mysqli_fetch_array($sections);
								   
								?>
						 
						   <input type="text" class="form-control" id="si" name="si" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $section['sname'];?>" readonly>
				    ...
				    <div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                          <?php 
								   $machines= mysqli_query($db,"SELECT * FROM machines where mi='".$complaint['mi']."'");
								   $machine = mysqli_fetch_array($machines);
								   
								?>
						 
						   <input type="text" class="form-control" id="mi" name="mi" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $machine['mname'];?>" readonly>
					   </div>
                    </div>
					...
					<div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                            <div id="get_op">
							<?php 
								   $ops= mysqli_query($db,"SELECT * FROM operators where oi='".$complaint['oi']."'");
								   $op = mysqli_fetch_array($ops);
								   
								?>
						 
						   <input type="text" class="form-control" id="oi" name="oi" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $op['oname'];?>" readonly>
							</div>
					   </div>
                    </div>
					<div class="col-md-6 mb-3">
					...
					<div class="col-md-6 mb-3">
                        <label for="validationTooltipUsername">Objection(s) By Q&amp;EHS</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="objection"  name="objection" aria-describedby="validationTooltipUsernamePrepend" value="<?php echo $ccomplaint['objection'];?>" readonly>
                            <div class="invalid-tooltip">
					...
					<div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="objremarks"  name="objremarks" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $ccomplaint['objremarks'];?>" readonly>
                            <div class="invalid-tooltip">
					...
					<div class="col-md-12 mb-3">
                        <label for="validationTooltipUsername">Follow Up(s)</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="objremarks"  name="objremarks" aria-describedby="validationTooltipUsernamePrepend" required="" value="<?php echo $ccomplaint['followup'];?>">
                            <div class="invalid-tooltip">

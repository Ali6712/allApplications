        ...
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r_id=<?php echo $_GET['r_id'];?>&r1_pl_id=<?php echo $pl['r1_pl_id'];?>&insert=pd_3ra&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
						 ...
						 <div class="accordion-row open" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_plan_date_trails" name="pd2r_plan_date_trails" aria-describedby="validationTooltipUsernamePrepend" required >
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_etd" name="pd2r_etd" aria-describedby="validationTooltipUsernamePrepend" required >
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_remarks" name="pd2r_remarks" aria-describedby="validationTooltipUsernamePrepend" required >

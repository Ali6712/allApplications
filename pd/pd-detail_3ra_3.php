        ...
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r_id=<?php echo $_GET['r_id'];?>&r1_pl_id=<?php echo $pl['r1_pl_id'];?>&insert=pd_3r_3&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">

    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Basic Initial Work & Comparison</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r1_pl_id=<?php echo $pl['r1_pl_id'];?>&insert=pd_2r&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
                              ...
                              <div class="col-md-6 mb-3">
								...
								<div class="input-group">
										<select id="marked_to_id<?php echo $pl['r1_pl_id'];?>" name="marked_to_id<?php echo $pl['r1_pl_id'];?>" class="form-control" disabled>
											   <option value="">Select</option>
											<?php 
											   $users= mysqli_query($db,"SELECT * FROM tblusers where user_type='Lab'");
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
                              <div class="col-md-6 mb-3">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_closest_existing_grade" name="pd2r_closest_existing_grade" aria-describedby="validationTooltipUsernamePrepend" required>
									   <div class="invalid-tooltip">
                                Please enter Closest Existing Grade.
								 </div>
									</div>
								</div>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_closest_trail_grade" name="pd2r_closest_trail_grade" aria-describedby="validationTooltipUsernamePrepend" required>
									   <div class="invalid-tooltip">
                                Please enter Closest Trial Grade.
								 </div>
									</div>
								</div>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_recommendation" name="pd2r_recommendation" aria-describedby="validationTooltipUsernamePrepend" required>
									   <div class="invalid-tooltip">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_recommendation_date" name="pd2r_recommendation_date" aria-describedby="validationTooltipUsernamePrepend" required>
									   <div class="invalid-tooltip">
                                Please enter Recommendation Date.
								 </div>
									</div>
								</div>
								<div class="col-md-6 mb-3">
								...
								<div class="input-group">
								 <select id="pd2r_new_dev_required" name="pd2r_new_dev_required" class="form-control" onchange="check_yn(this.value);" aria-describedby="validationTooltipUsernamePrepend" required>
											   <option value="">Select</option>
											<?php 
											   $yno= mysqli_query($db,"SELECT * FROM tblyesno");
											   while($yn = mysqli_fetch_array($yno)){   
									   ...
									   <div class="invalid-tooltip">
                                Please select New development Required.
								 </div>
									 </div>
								</div>  
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_plan_date_trails" name="pd2r_plan_date_trails" aria-describedby="validationTooltipUsernamePrepend" required value="">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd2r_etd" name="pd2r_etd" aria-describedby="validationTooltipUsernamePrepend" required value="">

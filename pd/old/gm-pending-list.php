        ...
        <div class="card-body">
            <table id="example1" class="table table-striped table-bordered">
				...
				<?php 
				  ...
				  $concern_complaints= mysqli_query($db,"
				  SELECT * FROM complain c, concern_dept cd where c.comp_for 
				  IN (".$_SESSION['dept'].") and c.Serno=cd.serno and c.cstatus='Approved' order by c.Serno asc");
		       ...
		       ?>
		        <tr>
                 <td><a href="gm-detail.php?id=<?php echo base64_encode($concern_complaint['serno']);?>"><?php echo $concern_complaint['serno'];?></a></td> 

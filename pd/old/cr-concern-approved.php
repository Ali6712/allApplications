...
<head>
    ...
    <title><?php echo $title;?>Concern Department Approved Complaints</title>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:">Concern Department Approved Complaints</a></li>
...
<div class="card">
        <div class="card-body">
            <h6 class="card-title">Enter your detail to view approved complaints.</h6>
            <form class="needs-validation" novalidate="" action="controllers/complaints.php?check=c-dept" method="POST"  enctype="multipart/form-data">
				    ...
				    <div class="form-group row">
                            ...
                            <div class="col-sm-3">
								...
								<?php 
								   $departments= mysqli_query($db,"SELECT * FROM departments order by dname asc");

        ...
        <div class="card-body">
            <table  class="table table-striped table-bordered">
				...
				<?php 
				   ...
				   $developments= mysqli_query($db,"SELECT * FROM tblrank1 where r1_created_by='".$_SESSION['user_id']."' order by r1_id desc");
				   ...
				   $statuss= mysqli_query($db,"SELECT * FROM tblpstatus where r1_id='".$development['r1_id']."' order by pd_id desc limit 0,1");
				   ...
				   $plines= mysqli_query($db,"select psl.pld_name,pl.pl_name
		       ...
		       ?>
                <tr>
                <td>
                    <?php echo $pline['pl_name'];?>-<?php echo $development['r1_year'];?>-<?php echo $development['r1_id'];?>
				...
				<td>
				   <?php if($status['r1_status']=='Rejected'){?>
				    <span class="badge badge-pill badge-danger">
				    <?php echo $status['r1_status'];?>
				    </span>
				   <?php }else{?>

    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Rank 5</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?>
						<form class="needs-validation" novalidate="" action="controllers/development.php?insert=rank5&r1_pl_id=<?php echo $_GET['r1_pl_id'];?>&id=<?php echo $_GET['id'];?>" method="POST"  enctype="multipart/form-data">

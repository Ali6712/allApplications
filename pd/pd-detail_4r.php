    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Development Completed </h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r1_pl_id=<?php echo base64_decode($_GET['r1_pl_id']);?>&insert=pd_4r&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
						...
						<div class="accordion-row open" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<select id="pd4r_final_report" name="pd4r_final_report" class="form-control"  required>
											   <option value="">Select</option>
											<?php 
								...
								<input type="file" class="form-control" id="pd4r_final_report_att" name="pd4r_final_report_att"  required>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd4r_sample_code" name="pd4r_sample_code" required>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd4r_sample_qty" name="pd4r_sample_qty" required>

    ...
    <div class="navigation-menu-body">
        <ul id="navigationDashboards" class="navigation-active">
           ...
           <li>
                <a href="#">Reports</a>
                <ul>
                    <li><a href="datewise-lab.php?id=<?php echo $_GET['id'];?>">Datewise </a></li>
...
<div class="header">
    ...
    <div class="header-logo">
        <a href="dashboard-lab.php?id=<?php echo $_GET['id'];?>">
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="dashboard-lab.php?id=<?php echo $_GET['id'];?>">Dashboard</a></li>

...
<?php 
$select=mysqli_query($db,"select * from types where id='".$_GET['id']."'");
...
<option value="<?php echo $row['di'];?>" <?php if($row2['di']==$row['di']){echo "selected='selected'";}?>><?php echo $row['dname'];?></option>
					...
					<div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control form-control-sm" id="tname" name="tname" required value="<?php echo $row2['tname']; ?>">
                            </div>
                    </div>

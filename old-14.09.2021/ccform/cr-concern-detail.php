                        ...
                        <div class="input-group">
                             ...
                             <select id="production_line" name="production_line" class="form-control" required>
								   ...
								   if($complaint['comp_for'] == '2'){
									...
									$plines=mysqli_query($db,"select * from productlines where di='2'");
                                    while($row_pline=mysqli_fetch_array($plines)){
										
									
								   ?>
								   <option value="<?php echo $row_pline['lname'];?>"><?php echo $row_pline['lname'];?></option>
								   
								   <?php } } ?>
								   <?php 
								   if($complaint['comp_for'] == '31'){
									   
								   $plines=mysqli_query($db,"select * from productlines where di='31'");
                                    while($row_pline=mysqli_fetch_array($plines)){	   
								   ?>
								   <option value="<?php echo $row_pline['lname'];?>"><?php echo $row_pline['lname'];?></option>

    ...
    <div class="card">
        <div class="card-body">
            <table id="example1" class="table table-striped table-bordered">
                ...
                <tbody>
				<?php 
				   $complaints= mysqli_query($db,"SELECT * FROM complain where issue_dept='".$_SESSION['dname']."' and status='Approved' order by Serno desc");
				   while($complaint = mysqli_fetch_array($complaints)){  
                    					 
		       ?>
                <tr>
                <td><a href="cr-approved-detail.php?id=<?php echo base64_encode($complaint['Serno']);?>&status=<?php echo base64_encode('approved');?>"><?php echo $complaint['Serno'];?></a></td> 

...
elseif($_GET['insert']=='complaint'){
	...
	if($filename!=""){
	$cc_file = $file_basename.$file_ext;
	move_uploaded_file($_FILES["file"]["tmp_name"], "../../ccform-live/Upload/" . $cc_file);
    }
...
elseif($_GET['edit']=='gm-complaint'){
    ...
    //$url = 'http://125.209.111.117/applications/ccform-live';
	...
	'.$detail2.'	</td>
     ...
     <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Discounted Sale').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
	transition-delay: .2s;">Discounted Sale</a>	</td>
     ...
     <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Customer Satisfied').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
	transition-delay: .2s;">Customer Satisfied</a>	</td>
     ...
     <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Material Return').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
	transition-delay: .2s;">Material Return</a>	</td>
     ...
     <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Customer Consumed Material Conditionally').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
	transition-delay: .2s;">Customer Consumed Material Conditionally</a>	</td>
     ...
     <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Material Replaced').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
    ...
    <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Further trials recommended').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
    ...
    <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Claimed').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
	transition-delay: .2s;">Claimed</a>	</td>
     ...
     <tr>
	<td style="padding: 5px 0 5px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 15px; text-align:center;">
	<a href="'.$url2.'/status.php?id='.$row_to['Serno'].'&action='.base64_encode('Others').'&update=status" class="go-shop-btn btn btn-fill-type" style="padding-top: 6px;padding-bottom: 6px; float:left;    border: 2px solid #333;
	padding: 11px 15px;
	color: #333333;
	transition: .3s all linear;
	-webkit-transition-delay: .2s;
...
elseif($_GET['edit']=='qa-followup-complaint'){
	...
	$dname=base64_decode($_GET['id']);
	$dpassword = $_POST['odpassword'];
	$select_dept = mysqli_query($db,"SELECT * 
									 FROM departments 
									 WHERE di     ='".mysqli_real_escape_string($db,$dname)."' 
									 AND   dpassword ='".mysqli_real_escape_string($db,$dpassword)."'");
	...
	if ( $check_dept > 0 ) {
	     $update = mysqli_query($db,"update departments set dpassword='".mysqli_real_escape_string($db,$_POST['ndpassword'])."' where di='".$dname."'");
	     header("location: ../cr-concern-pending.php");
	}
	else{
	    $id=$_GET['id'];
	header("location: ../change-password.php?id=$id&error");
	}
}
?> 

                ...
                <div class="form-row">
					...
					<div class="col-md-3 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select id="sample_detail" name="sample_detail" class="form-control" disabled>
                                   <option value=""></option>
								   <option value="Defective product sample">Defective Product Sample</option>
								   <option value="Standard Product Sample">Standard Product Sample </option>
								   <option value="Defective and Standard Sample">Defective and Standard Sample</option>
						   </select>

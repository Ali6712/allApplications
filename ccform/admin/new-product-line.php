...
<head>
    ...
    <title><?php echo $title;?>New Product Line</title>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:">New Product Line</a></li>
...
<div class="card">
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate="" action="controllers/pline.php?insert=pline" method="POST"  enctype="multipart/form-data">

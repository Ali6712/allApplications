    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Rank 4</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?>
						<form class="needs-validation" novalidate="" action="controllers/development.php?insert=rank4&r1_pl_id=<?php echo $_GET['r1_pl_id'];?>&id=<?php echo $_GET['id'];?>" method="POST"  enctype="multipart/form-data">
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
                              <div class="col-md-6 mb-3">
								...
								<div class="input-group">
										<select id="marked_to_id" name="marked_to_id" class="form-control" disabled>
											   <option value="">Select</option>
											<?php 
						...
						<?php 
						   $pd2rs=mysqli_query($db,"select * from tblpd2r where r1_pl_id='".base64_decode($_GET['r1_pl_id'])."'");
						...
						?>
						 <div class="accordion-row" >
                            <a href="#" class="accordion-header">
                                <span>PD 2 (Basic Initial Work & Comparison)</span>
                                <i class="accordion-status-icon close fa fa-chevron-up"></i>
                                <i class="accordion-status-icon open fa fa-chevron-down"></i>
                            </a>
                            <div class="accordion-body">
						...
						<div class="accordion-row" >
                            <a href="#" class="accordion-header">
                                <span>PD 3 (Currently Under Trials)</span>
                                <i class="accordion-status-icon close fa fa-chevron-up"></i>
                                <i class="accordion-status-icon open fa fa-chevron-down"></i>
                            </a>
                            <div class="accordion-body">
						...
						<div class="accordion-row open" >
                            <a href="#" class="accordion-header">
                                <span>PD 4 (Development Completed)</span>
                                <i class="accordion-status-icon close fa fa-chevron-up"></i>
                                <i class="accordion-status-icon open fa fa-chevron-down"></i>
                            </a>
                            <div class="accordion-body">
						...
						<?php 
						   $pd3rs=mysqli_query($db,"select * from tblrank3 where r1_pl_id='".base64_decode($_GET['r1_pl_id'])."'");
						...
						<div class="accordion-row open" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r4_result_date" name="r4_result_date" required readonly value="<?php echo date('m/d/Y');?>" >
								...
								<div class="input-group">
										<select id="r4_result" name="r4_result" class="form-control"  required onchange="get_fail(this.value);"> 
											   <option value="">Select</option>
											<?php 
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r4_feedback_detail" name="r4_feedback_detail" required>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r4_trail_date" name="r4_trail_date" >
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r4_trail_o_qty" name="r4_trail_o_qty" >
								...
								<div class="input-group">
										<input type="text" class="form-control" id="rf_reporting_date" name="rf_reporting_date" readonly value="<?php echo date('m/d/Y');?>" >
								...
								<div class="input-group">
										<select id="rf_type" name="rf_type" class="form-control"> 
											   <option value="">Select</option>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="rf_reason" name="rf_reason" >
								...
								<div class="input-group">
									<select id="rf_dsr" name="rf_dsr" class="form-control"> 
											  <option value="">Select</option>
											<?php 
											   $yno= mysqli_query($db,"SELECT * FROM tblyesno");
											   while($yn = mysqli_fetch_array($yno)){   
											?>
											   <option value="<?php echo $yn['yn_option'];?>"><?php echo $yn['yn_option'];?></option>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="rf_rsolution" name="rf_rsolution" >
								...
								<div class="input-group">
										<input type="file" class="form-control" id="rf_att" name="rf_att" >
								...
								<div class="input-group">
										<input type="text" class="form-control" id="rf_r_date" name="rf_r_date" >
								...
								<div class="input-group">
										<select id="rf_sample_received_from" name="rf_sample_received_from" class="form-control" >
											   <option value="">Select</option>
											<?php 
											   $rtypes= mysqli_query($db,"SELECT * FROM tblrectypes where r_status='1'");
											   while($rtype = mysqli_fetch_array($rtypes)){   

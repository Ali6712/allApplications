...
<div class="card">
        <div class="card-body">
            ...
            where rpl.r1_id='".base64_decode($_GET['Serno'])."' and rpl.pld_id=psl.pld_id 
            and psl.pl_id=pl.pl_id");
            $pline = mysqli_fetch_array($plines);
            ?>
			<div class="alert alert-success" role="alert">
                        Development Created Successfully. Development No is <?php echo $pline['pl_name'].'-'.date('Y').'-'.
                            base64_decode($_GET['Serno']);?>
            </div>
			<?php } ?>

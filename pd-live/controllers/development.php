...
elseif($_GET['insert']=='rank_2b'){
	...
	if($filename!=""){
	$attachment     = $file_basename.$file_ext;
	move_uploaded_file($_FILES["attachment".$id]["tmp_name"], "../../pd/upload/" . $attachment);
    }	 
...
elseif($_GET['insert']=='pd_4r'){
	...
	if($filename!=""){
	$pd4r_final_report_att     = $file_basename.$file_ext;
	move_uploaded_file($_FILES["pd4r_final_report_att"]["tmp_name"], "../../pd/upload/" . $pd4r_final_report_att);
    }
	...
	if($filename!=""){
	$attachment     = $file_basename.$file_ext;
	move_uploaded_file($_FILES["rf_att"]["tmp_name"], "../../pd/upload/" . $attachment);
    }  

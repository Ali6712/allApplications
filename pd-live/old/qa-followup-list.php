...
<head>
    ...
    <title><?php echo $title;?>QA Follow Up Complaints</title>
    ...
    <div class="header-body">
        ...
        <div class="header-body-left">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:">QA Follow Up Complaints</a></li>
        ...
        <div class="card-body">
            <table id="example1" class="table table-striped table-bordered">
				...
				<?php 
				  ...
				  $concern_complaints= mysqli_query($db,"select * from concern_dept where issue_dept='".$_SESSION['dname']."' and status_ip='Approved' and status_followup='Pending' 
				  and region ='PKGS' order by serno desc");
		       ...
		       ?>
                <tr>
                <td><a href="qa-followup-detail.php?id=<?php echo base64_encode($concern_complaint['serno']);?>"><?php echo $concern_complaint['serno'];?></a></td> 
				...
				<td><?php echo $concern_complaint['app_date_con'];?></td>
                </tr>
			   <?php } ?>
				</tbody>

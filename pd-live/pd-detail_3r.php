    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Currently Under Trials</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r1_pl_id=<?php echo $pl['r1_pl_id'];?>&insert=pd_3r&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">
						 ...
						 <div class="accordion-row open" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd3r_dev_start_date" name="pd3r_dev_start_date" required>
								...
								<label for="validationTooltipUsername">Development Starting Time</label>
								 <div class="input-group clockpicker-demo">
									...
									<input type="text" id="pd3r_dev_start_time" name="pd3r_dev_start_time" class="form-control" >
								</div>
								</div>
								...
								<div class="input-group">
									<select id="pd3r_dev_status" name="pd3r_dev_status" class="form-control">
											   <option value="">Select</option>
											<?php 
											   $dss= mysqli_query($db,"SELECT * FROM tbldevstatus");
											   while($ds = mysqli_fetch_array($dss)){   
											?>
											   <option value="<?php echo $ds['d_option'];?>"><?php echo $ds['d_option'];?></option>
								...
								<div class="input-group">
									<select id="pd3r_dev_reason" name="pd3r_dev_reason" class="form-control">
											   <option value="">Select</option>
											<?php 
											   $rss= mysqli_query($db,"SELECT * FROM tblsreason");
											   while($rs = mysqli_fetch_array($rss)){   
											?>
											   <option value="<?php echo $rs['r_option'];?>"><?php echo $rs['r_option'];?></option>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="pd3r_dev_end_date" name="pd3r_dev_end_date" required>
								...
								<label for="validationTooltipUsername">Development Completion Time</label>
								 <div class="input-group clockpicker-demo">
									...
									<input type="text" id="pd3r_dev_end_time" name="pd3r_dev_end_time" class="form-control" >
								</div>
								</div>

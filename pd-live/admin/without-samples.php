...
$select = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and comp_for='".base64_decode($_GET['id'])."' and comp_sample='No' and c_year='".date('Y')."'");

}else{

$select = mysqli_query($db,"SELECT * FROM complain where Serno > '0' and comp_sample='No' and c_year='".date('Y')."'");
}
...
<head>
    ...
    <title><?php echo $title;?>Without Sample Complaints - <?php echo date("Y");?></title>

            ...
            <table id="example1" class="table table-striped table-bordered">
				...
				<?php 
				 ...
				 $select_recents= mysqli_query($db,"select *
						  ...
						  and r2d.r2_lab_received_flag='Y' and r2d.final_status is not null and rpl.r1_id=r1.r1_id ");
				   ...
				   while($row_recent     = mysqli_fetch_array($select_recents)){	
							...
							$rank6s=mysqli_query($db,"select * from tblrank6 where 
							r1_pl_id='".$row_recent["r1_pl_id"]."'");
							$num6=mysqli_num_rows($rank6s);
		       ...
		       ?>
                <tr>
								...
								<td>
							<a href="pd-completed-detail.php?id=<?php echo base64_encode($row_recent['r1_pl_id']);?>" class="btn btn-outline-light btn-sm">View </a>
								</td>
                            </tr>

    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Re-Development Completed </h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?><form method="post" action="controllers/development.php?r_id=<?php echo $_GET['r_id'];?>&r1_pl_id=<?php echo base64_decode($_GET['r1_pl_id']);?>&insert=pd_3r_4&id=<?php echo $_GET['id'];?>" enctype="multipart/form-data">

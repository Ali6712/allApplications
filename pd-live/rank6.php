    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Rank 6</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?>
						<form class="needs-validation" novalidate="" action="controllers/development.php?insert=rank6&r1_pl_id=<?php echo $_GET['r1_pl_id'];?>&id=<?php echo $_GET['id'];?>" method="POST"  enctype="multipart/form-data">
						...
						<div class="accordion-row" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r3_etd_feedback2" name="r3_etd_feedback2" value="<?php echo $pd3r['r3_etd_feedback'];?>" disabled >
						  ...
						  <div class="accordion-row open" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r6_so" name="r6_so"  required >
								...
								<label for="validationTooltipUsername">S.O Date</label>
								<div class="input-group">
										<input type="text" class="form-control" id="r6_so_date" name="r6_so_date"  required >
								...
								<label for="validationTooltipUsername">S.O Qty</label>
								<div class="input-group">
										<input type="text" class="form-control" id="r6_so_qty" name="r6_so_qty"  required >
								...
								<label for="validationTooltipUsername">S.O Value</label>
								<div class="input-group">
										<input type="text" class="form-control" id="r6_so_value" name="r6_so_value"  required >
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r6_rsf" name="r6_rsf" required>
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r6_next_o_date" name="r6_next_o_date" required>
								...
								<label for="validationTooltipUsername">First Bulk trial Result/FeedBack</label>
								<div class="input-group">
										<input type="text" class="form-control" id="r6_result" name="r6_result" required >

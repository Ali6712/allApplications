    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Rank 6A</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?>
						<form class="needs-validation" novalidate="" action="controllers/development.php?r_id=<?php echo $_GET['r_id'];?>&insert=rank6a&r1_pl_id=<?php echo $_GET['r1_pl_id'];?>&id=<?php echo $_GET['id'];?>" method="POST"  enctype="multipart/form-data">
...
<?php 
				        ...
				        <?php 
						   $pd5rs=mysqli_query($db,"select * from tblrank5a where r_id='".base64_decode($_GET['r_id'])."'");
						...
						?>
						 ...
						 <div class="accordion-row open" >
                            <a href="#" class="accordion-header">
                                <span>Rank 6A (Second Order)</span>
                                <i class="accordion-status-icon close fa fa-chevron-up"></i>
                                <i class="accordion-status-icon open fa fa-chevron-down"></i>
                            </a>
                            <div class="accordion-body">

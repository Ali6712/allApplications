    ...
    <div class="card">
        <div class="card-body">
             <div class="col-md-12">
                    ...
                    <h6 class="card-title">Product Development Form - Rank 4A</h6>
                    <div class="accordion accordion-success custom-accordion">
						...
						?>
						<form class="needs-validation" novalidate="" action="controllers/development.php?r_id=<?php echo $_GET['r_id'];?>&insert=rank4a&r1_pl_id=<?php echo $_GET['r1_pl_id'];?>&id=<?php echo $_GET['id'];?>" method="POST"  enctype="multipart/form-data">
						...
						<div class="accordion-row open" >
                            ...
                            <div class="accordion-body">
							 ...
							 <div class="form-row">
								...
								<div class="input-group">
										<input type="text" class="form-control" id="r4_result_date" name="r4_result_date" required >
								...
								<label for="validationTooltipUsername">Reporting Date </label>
								<div class="input-group">
										<input type="text" class="form-control" id="rf_reporting_date" name="rf_reporting_date" >

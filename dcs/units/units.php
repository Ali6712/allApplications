...
$units=mysqli_query($db,"SELECT * FROM tbl_units WHERE FLD_ID > 0");
?>
<!DOCTYPE html>
<html lang="en">
	<!--begin::Head-->
<head>
	...
	<body id="kt_body" class="quick-panel-right demo-panel-right offcanvas-right header-fixed header-mobile-fixed aside-enabled aside-static page-loading">
		...
		<th>Action</th>											
											...
											<tbody>
											    <?php while($unit=mysqli_fetch_array($units)){?>
												<tr>
													<td><?php echo $unit['FLD_ID'];?></td>
													<td><?php echo $unit['FLD_UNAME'];?></td>
													<td>
													<?php 
													if($unit['FLD_UFLAG']=='Inactive'){
													?>
													<span class="label label-lg font-weight-bold label-light-danger label-inline">Inactive</span>
													<?php }elseif($unit['FLD_UFLAG']=='Active'){?>
...
<a href="<?php echo $url;?>/units/edit-unit.php?FLD_ID=<?php echo $unit['FLD_ID'];?>"> 

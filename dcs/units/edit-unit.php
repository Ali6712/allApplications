...
$units=mysqli_query($db,"SELECT * FROM tbl_units WHERE FLD_ID = '".$_GET['FLD_ID']."'");
...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
 <div class="card-header">
  <div class="card-title">
   <h3 class="card-label">
    <i class="flaticon2-edit text-primary"></i> Unit<i class="mr-2"></i>
    ...
    <div class="col-xl-8">
     <div class="my-5">
      <div class="form-group row">
       <label class="col-3">Unit Name</label>
       <div class="col-9">
        <input type="text" class="form-control form-control-solid" id="FLD_UNAME" name="FLD_UNAME" value="<?php echo $unit['FLD_UNAME'];?>" maxlength="256"
		required />
       </div>
      </div>

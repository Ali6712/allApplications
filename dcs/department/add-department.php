    ...
    <div class="col-xl-8">
	 ...
	 <div class="form-group row">
       ...
       <div class="col-9">
		 ...
		 ?>
		 <option value="<?php echo $unit['FLD_ID'];?>"><?php echo $unit['FLD_UNAME'];?></option>
		 <?php 	   }
		 ?>
        </select>
       </div>
      ...
      <div class="form-group row">
       ...
       <div class="col-9">
       <input type="text" class="form-control form-control-solid" id="FLD_DNAME" name="FLD_DNAME" placeholder="Compliance" required maxlength="256" />

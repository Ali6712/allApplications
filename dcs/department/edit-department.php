...
$departments=mysqli_query($db,"SELECT * FROM tbl_depts WHERE FLD_ID ='".$_GET['FLD_ID']."'");
...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
 <div class="card-header">
  <div class="card-title">
   <h3 class="card-label">
    <i class="<?php echo $_GET['icon'];?> text-primary"></i> Department <i class="mr-2"></i>
   ...
   <div class="row">
    ...
    <div class="col-xl-8">
	 ...
	 <div class="form-group row">
       ...
       <div class="col-9">
         <select class="form-control form-control-solid" id="FLD_UNAME" name="FLD_UNAME" >
		 <option value=""></option>
         <?php $units=mysqli_query($db,"SELECT * FROM tbl_units WHERE FLD_UFLAG='Active'");
		       while($unit = mysqli_fetch_array($units)){
		 ?>
		 <option value="<?php echo $unit['FLD_ID'];?>" <?php if($department['FLD_UNAME']==$unit['FLD_ID']){echo "selected='selected'";}?>><?php echo $unit['FLD_UNAME'];?></option>
		 <?php 	   }
		 ?>
        </select>
       </div>
      ...
      <div class="form-group row">
       ...
       <div class="col-9">
       <input type="text" class="form-control form-control-solid" id="FLD_DNAME" name="FLD_DNAME" value="<?php echo $department['FLD_DNAME'];?>" required maxlength="256" />

...
$users=mysqli_query($db,"SELECT * FROM tbl_usr02 WHERE FLD_ID = '".$_GET['FLD_ID']."'");
					...
					<div class="wizard wizard-1" id="kt_wizard" data-wizard-state="step-first" data-wizard-clickable="false">
							...
							<div class="wizard-steps p-8 p-lg-10">
								...
								<div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
									<div class="wizard-label">
										...
										<h3 class="wizard-title">Edit User</h3>
									</div>
						...
						<div class="row justify-content-center my-10 px-8 my-lg-15 px-lg-10">
							<div class="col-xl-12 col-xxl-7">
								<!--begin::Wizard Form-->
								<form class="form" id="kt_form" action="controller.php?action=edit&FLD_ID=<?php echo $_GET['FLD_ID'];?>" method="POST">
									<!--begin::Wizard Step 1-->
									<div class="pb-5" data-wizard-type="step-content" data-wizard-state="current">
											...
											<div class="col-xl-6">
												...
												<div class="form-group">
													...
													<select class="form-control form-control-solid" id="FLD_BTYPE" name="FLD_BTYPE" required>
													 <option value=""></option>
													 <option value="Admin" <?php if($user['FLD_BTYPE']=='Admin'){echo "selected='selected'";}?>>Admin</option>
													 <option value="Dept" <?php if($user['FLD_BTYPE']=='Dept'){echo "selected='selected'";}?>>Department Admin</option>
													 <option value="Viewer" <?php if($user['FLD_BTYPE']=='Viewer'){echo "selected='selected'";}?>>Viewer</option>
													</select>
										...
										<div class="col-xl-6">
												...
												<div class="form-group">
												    ...
												    ?>	
													 <option value="<?php echo $department['FLD_ID'];?>" <?php if($user['FLD_DNAME']==$department['FLD_ID']){echo "selected='selected'";}?>><?php echo $department['FLD_DNAME']?></option>
													 <?php 	   }
													 ?>
													 </optgroup>
													 <?php 	   }
										...
										<div class="form-group">
											...
											<input type="text" class="form-control form-control-solid form-control-lg" name="FLD_BNAME" placeholder="administrator" maxlength="40" required value="<?php echo $user['FLD_BNAME'];?>"  />
										</div>
										<!--end::Input-->
										<!--begin::Input-->
										<div class="form-group">
											<label>Password</label>
											<input type="text" class="form-control form-control-solid form-control-lg" name="FLD_BCODE" value="<?php echo $user['FLD_BCODE'];?>" maxlength="40"   />
										</div>
										<!--end::Input-->
										<!--begin::Input-->
										<div class="form-group">
											<label>Email</label>
											<input type="email" class="form-control form-control-solid form-control-lg" name="FLD_EMAIL" value="<?php echo $user['FLD_EMAIL'];?>" required  />
										</div>
										<!--end::Input-->

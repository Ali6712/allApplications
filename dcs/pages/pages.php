								...
								<div class="card card-custom">
									...
									<div class="card-body">
										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
											...
											<tbody>
											    <?php while($page=mysqli_fetch_array($pages)){
													  $users=mysqli_query($db,"SELECT FLD_BNAME FROM tbl_usr02 
													                           WHERE FLD_ID = '".$page['FLD_ANAME']."'");
																			   
												      $user=mysqli_fetch_array($users);
												?>
												<tr>
													<td><?php echo $page['FLD_ID'];?></td>
													<td><?php echo $page['FLD_OBJECT_TYPE'];?> - <?php echo $page['FLD_OBJECT'];?></td>
													<td><?php echo $page['FLD_PARENT'];?></td>
													<td><?php echo $page['FLD_OBJECT_NAME'];?></td>
													<td><i class="<?php echo $page['FLD_MENU_ICON'];?> text-primary"></i></td>
													<td><?php echo $page['FLD_MENU_NAME'];?></td>
													<td><?php echo $page['FLD_SHORT_CODE'];?></td>
													<td><?php echo $page['FLD_OBJECT_FUNC'];?></td>
													<td><?php echo $user['FLD_BNAME'];?></td>
													<td><?php echo date("d-M-y", strtotime($page['FLD_ERDAT']));?></td>
													<td>
													<?php 
													if($page['FLD_STATUS']=='Inactive'){
													?>
													<span class="label label-lg font-weight-bold label-light-danger label-inline">Inactive</span>
													<?php }elseif($page['FLD_STATUS']=='Active'){?>
													<span class="label label-lg font-weight-bold label-light-success label-inline">Active</span>
													<?php }elseif($page['FLD_STATUS']=='Deleted'){?>
													<span class="label label-lg font-weight-bold label-light-info label-inline">Deleted</span>
													<?php } ?>
													</td>

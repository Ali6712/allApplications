...
<head>
										...
										<table class="table table-separate table-head-custom table-checkable" id="kt_datatable1">
											<thead>
												<tr>
													...
													<th>Department</th>
													<th>Document Type</th>
													<th>Document Title <br> Document No</th>
													<th>Issue Status</th>
											...
											<tbody>
											    <?php while($document=mysqli_fetch_array($documents)){
													  $departments=mysqli_query($db,"SELECT * FROM tbl_depts	
													  WHERE FLD_ID='".$document['FLD_DNAME']."'");
		                                              $department = mysqli_fetch_array($departments);
													  
										
												?>
												<tr>
													<td><?php echo $document['FLD_ID'];?></td>
													<td><?php echo $department['FLD_DNAME'];?> </td>
													<td><?php echo $document['FLD_DTYPE'];?></td>
													<td><?php echo $document['FLD_DTITL'];?><br><?php echo $document['FLD_DCNUM'];?></td>
													<td><span class="label label-warning label-inline mr-2"><?php echo $document['FLD_ISTAT'];?> </span></td>
													<td>
													<span class="label label-info label-inline mr-2"><?php echo $document['FLD_RPRD'];?> </span></td>
													<td>
													<a href="<?php echo $url;?>/browse/<?php echo $document['FLD_DFILE'];?>" target="_blank"> 
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" x="6" y="15" width="5" height="2" rx="1"/>
													...
													<td><?php echo $document['FLD_VISBL'];?></td>
													
													<td>
													<?php 
													if($document['FLD_DFLAG']=='Inactive'){
													?>
													<span class="label label-lg font-weight-bold label-light-danger label-inline">Inactive</span>
													<?php }elseif($document['FLD_DFLAG']=='Active'){?>
